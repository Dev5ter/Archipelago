...
wind_waker_regions = [
    ...
    ('Islet of Steel', []),
    ('Stone Watcher Cave', []),
    ('Private Oasis', ['Cabana Labryinth Entrance']),
    ('Cabana Labryinth', []),
    ...
    ('Cliff Platue Cave', ['Cliff Platue Upper Entrance']),
    ('Cliff Platue Upper', []),
    ('Horseshoe Cave', []),
    ('Outset - Grasscutters House', []),
    ('Outset - Under Grandmas House', []),
    ('Outset - Savage Labryinth First', ['Savage Labryinth Second Entrance']),
    ('Outset - Jabuns Cave', []),
    ('Savage Labryinth Second', []),
    ('Outset - Orcas House', []),
...
mandatory_connections = [
    ...
    ('Cabana Labryinth Entrance', 'Cabana Labryinth'),
    ...
    ('Cliff Platue Cave Entrance', 'Cliff Platue Cave'),
    ('Cliff Platue Upper Entrance', 'Cliff Platue Upper'),
    ...
    ('Outset - Savage Labryinth Entrance', 'Outset - Savage Labryinth First'),
    ('Savage Labryinth Second Entrance', 'Savage Labryinth Second'),
