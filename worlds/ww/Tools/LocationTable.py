...
location_table: list[Location] = [  # 240/254/304
   #Location( "Name of Check"     StageID, chest, pickup, mem, bit#) 
    ...
    Location("Cliff Platue - Upper"    , 0x0, True, False, False, -1, False, -1, False, 1),
    ...
    Location("Fire Mountain - Lookout Platform - Cannon", 0x1, True, False, False, -1, False, -1, False, 0),
    Location("Fire Mountain - Lookout Platform - Free"  , 0x1, True, False, False, -1, False, -1, False, 1),
    ...
    Location("Islet of Steel - Defeat Platform" , 0x1, True, False, False, -1, False, -1, False, 16),
    ...
    Location("Cliff Platue - Free Platform"     , 0x1, True, False, False, -1, False, -1, False, 19),
    ...
    Location("Forbidden Woods - In Morphs Pit"    , 0x4, True, False, False, -1, False, -1, False, 8),
    ...
    Location("Cliff Platue - Cave"  , 0xC, True, False, False, -1, False, -1, False, 7),
